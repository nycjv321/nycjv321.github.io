...
In an Agile organization, it is understood that automation is utilizing for various things including tests. So for the purposes of this article, we are talking about automated testing unless otherwise stated. So assuming that we are _Agile_, let us think in broad terms of testing efforts in the context of an agile team. And let's define attributes and characteristics that define _bad_ tests. Once this is understood we can start discussing what are our ideal tests.
...
With the above in mind, what do you consider a good test? Where do your good tests end up? What about your bad tests? Do all [tests go to dog heaven](https://en.wikipedia.org/wiki/All_Dogs_Go_to_Heaven)? In your organization you should have a SME on testing and automated test or team leads with the expertise to ensure testing is properly utilized in your SDLC. The first steps to good testing strategies is:
1. questioning and understanding where your organization's need
